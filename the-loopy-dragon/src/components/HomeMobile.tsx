...
export default function HomeMobile() {
  ...
  // New Arrivals from Supabase Inventory
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-gray-800 flex flex-col font-sans">
        {/* Sticky Navbar + Marquee (handled inside Navbar) */}
  ...
  >
    ...
    <div className="relative h-full flex items-center">
      ...
      >
        ...
        <div className="w-full" style={{ padding: '0 2px' }}> {/* Reduced padding for edge-to-edge */}
          <Link
            href="/shop"
        ...
        <div className="max-w-sm mx-auto px-4">
                  ...
                  >
                    {product.ImageUrl1 ? (
                      <img 
                        ...
                        fetchPriority="low"
                        onError={(e) => {
                          e.currentTarget.src = 'data:image/svg+xml;base64,';
                        }}
                      />
                    ) : (
            ...
            <div className="w-full" style={{ padding: '0 2px' }}>
              <Link
                href="/shop"
                className="group215 bg-white text-black hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl w-full"
                style={{
                  height: 'clamp(60px, 18vw, 70px)',
                  display: 'flex',
                  flexDirection: 'row',
        ...
        {/* New Arrivals Section - Mobile Layout */}
        <section 
        className="w-full py-12"
        style={{
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {newArrivalsProducts.map((product, index) => (
                <div key={index} className="flex flex-col items-start">
                  ...
                  <div className="mt-3 text-left w-full">
                    <h3 
                    className="text-black mb-1 text-[15px] !text-[15px]"
                    style={{
                        fontFamily: 'Montserrat, sans-serif',
                        fontWeight: 100,
                        lineHeight: '1.2'
        ...
        >
            <div className="relative z-10 w-full max-w-md py-8 px-4 text-center">
                ...
                <div className="w-full flex justify-center" style={{ padding: '0 2px' }}>
                    <Link
                        href="/custom-order"
                        ...
                        style={{
                            ...
                            textDecoration: 'none',
                            width: '100%',
                            maxWidth: '360px', // Match View More button width
                            minWidth: 0,
                            paddingLeft: 0,
                            paddingRight: 0,
                            marginLeft: 0,
  ...
  <div className="max-w-md mx-auto">
    ...
    <div className="flex flex-col gap-7 pl-4">
      ...
      <div className="flex items-start gap-4">
        <div className="mt-1 text-[#D7B3FB]">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="max-w-7xl mx-auto px-3">
            ...
            <div className="w-full overflow-hidden shadow-lg mx-auto" style={{ maxWidth: '90%' }}> {/* Removed rounded-lg */}
                <img 
  ...
  <div className="w-full">
    {faqs.map((faq, idx) => (
      <div className="mb-3" key={idx}>
        <button
          className="flex justify-between items-center py-2 gap-4 px-3 w-full text-left bg-transparent border-none outline-none"
