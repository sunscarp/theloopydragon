        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <Link href="/owner/products" className="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400">
                Products
              </Link>
              ...
              <Link href="/owner/sellers" className="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400">
                Sellers
              </Link>
              ...
              <Link href="/owner/dragon-game" className="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400">
                Dragon Game
              </Link>
            </div>
          </div>
