...
export default function SellerSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    if (data.success && slabData.success) {
      const updated = {
        ...seller,
        free_delivery: freeDelivery,
        upi_id: upiId,
          ...
          <section className="bg-surface-container-lowest rounded-xl p-8 border border-primary/5 shadow-sm">
            ...
            <div className="pt-6 border-t border-surface-container mt-6">
              <div className="flex items-center gap-2 mb-4">
                <h4 className="font-label-sm text-on-surface-variant uppercase tracking-widest opacity-60">Delivery Slabs (by distance)</h4>
                    ...
                    <tbody>
                      {deliverySlabs.map((slab, idx) => (
                        <tr key={idx} className="border-b border-outline-variant/10">
                          ...
                          {/* TO — editable for all except last, which is always "and beyond" */}
