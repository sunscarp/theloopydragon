        ...
        <div className="col-span-12 lg:col-span-8 space-y-8">
          ...
          <section className="bg-surface-container-lowest rounded-xl p-8 border border-primary/5 shadow-sm">
            ...
            <div className="max-h-60 overflow-y-auto bg-surface-blue p-6 rounded-lg border border-outline-variant/30 mb-6 text-sm text-on-surface-variant leading-relaxed space-y-3">
              ...
              <p><strong>3. Fees &amp; Commission</strong><br />The Loopy Dragon currently charges 0% platform commission on sales. A 2% Razorpay payment processing fee is deducted from every transaction automatically. You will always receive: Sale Price – 2% Razorpay Fee = Your Payout. Commission rates and fee structures may change in the future. Sellers will be notified via email at least 7 days in advance of any such change. Continued listing of products after the notice period constitutes acceptance of the revised rates.</p>
